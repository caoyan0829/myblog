<template>
  <div class="app">
    <header class="header-navigation" id="header">
      <nav>
        <div class="logo"><a href="/">周永个人博客</a></div>
        <div class="search">
      ...
      <aside class="l_box">
        ...
        <div class="cloud">
          ...
          <ul>
            ...
            <a
              href="/">温暖</a> <a href="/">阳光</a> <a href="/">三星</a><a href="/">索尼</a> <a href="/">华维荣耀</a> <a
      ...
      <main>
        <div class="infosbox">
          <div class="newsview">
            ...
            <div class="bloginfo">
              <ul>
                <li class="author">作者：<a href="/">周永</a></li>
            ...
            <div class="news_about">
              <strong>简介</strong>个人博客，用来做什么？我刚开始就把它当做一个我吐槽心情的地方，也就相当于一个网络记事本，写上一些关于自己生活工作中的小情小事，也会放上一些照片，音乐。每天工作回家后就能访问自己的网站，一边听着音乐，一边写写文章。
            </div>
            <div class="news_con">
              ...
              《<u><a href="http://www.yangqq.com/jstt/web/2014-01-18/644.html"
                     target="_blank">我的个人博客之——阿里云空间选择</a></u>》<br>
              <br>
              ...
              <br>
              我的个人博客，在今年三月份之前是没有提供后台安装，调试这些服务的。其实一直都有人找我做个人博客，因为调试时间还有修改的问题，从上传到安装到修改调试，一般要四五个小时，我怕收费高，所以一直都是拒绝的。自从推出来《<u><a
              href="http://www.yangqq.com/download/div/2017-09-08/789.html"
              target="_blank">心蓝时间轴</a></u>》后，主动找我做网站的也多了，他们都说是我粉丝，喜欢我的模板，所以我在模板下面写了付费说明，我的个人博客也开始有了付费项目。<br>
              <br>
              <img alt="" src="images/6.jpg"><br>
              <br>
              我接到的第一单，是一位父亲，想给自家的宝贝建立一个博客。他说他想买一个域名，谈了好几天，最终花了8000多购买到，我挺敬佩他的，对孩子的爱，毫不吝啬。域名固然重要，其实我想说坚持用博客来记录宝贝成长点滴，才是最有价值的。第二单是一个阅读网站，从加他到跟他聊，看他朋友圈，很有才气的一个人，也相当有爱心，他的网站大部分是分享给一些爱好阅读的长者。还有些就是技术类的站长，做资讯，做旅游，做推广的。通常，从选的模板就能看出来网站类型。《<u><a
              href="http://www.yangqq.com/download/div/2017-09-08/789.html">心蓝时间轴</a></u>》偏个人，《<u><a
              href="http://www.yangqq.com/download/div/2018-03-18/807.html">绅士</a></u>》，《<u><a
              href="http://www.yangqq.com/download/div/2018-04-22/815.html" target="_blank">格调</a></u>》偏技术，资讯。《<u><a
              href="http://www.yangqq.com/download/div/2018-04-18/814.html" target="_blank">清雅</a></u>》，《<u><a
              href="http://www.yangqq.com/download/div/2017-07-16/785.html"
              target="_blank">水墨古典</a></u>》偏文艺。但也有对我防备心的，比如说付款方式，能不能走淘宝，这些我也能理解，但是有些吧，从一开始聊，感觉就不太好，理应就认为不应该收钱，收钱干嘛，到处都是免费的，听到这些，我也慢慢解释。其实他们并不了解我，了解我的网站，只要是从我博客来的，关注过一段时间的，都知道青姐的人品是咋样的。用“心塞”这个词，毫不为过吧。<br>
              <br>
          ...
          <div class="share">
            <p class="diggit"><a href="JavaScript:void(0);"> 很赞哦！ </a>(<b id="diggnum">13</b>)</p>
          </div>
          <div class="nextinfo">
    ...
    <footer>
      <p>Design by <a href="http://www.yangqq.com" target="_blank">周永个人博客</a> <a href="/">蜀ICP备11002373号-1</a></p>
    </footer>
